 ...
 */
public class PiMonteCarlo extends Configured implements Tool {
  static final String DESCRIPTION
      = "A map/reduce program that estimates Pi using a quasi-Monte Carlo method.";
  /** tmp directory for input/output */
  static private final String TMP_DIR_PREFIX = PiMonteCarlo.class.getSimpleName();
  ...
  public static BigDecimal estimatePi(int numMaps, long numPoints,
    ...
    //setup job conf
    job.setJobName(PiMonteCarlo.class.getSimpleName());
    job.setJarByClass(PiMonteCarlo.class);
  ...
  public static void main(String[] argv) throws Exception {
    System.exit(ToolRunner.run(null, new PiMonteCarlo(), argv));
  }
}
